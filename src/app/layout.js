...
//     <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5556527203517665"
...
export default function RootLayout({ children }) {
  return (
    <html lang="en"  crosspilot="">
      <head>
        {/* Render structured data safely on the server */}
        <Script
          id="structured-data"
      ...
      <body  cz-shortcut-listen="true">
        ...
        <Script
          async
          src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5556527203517665"
