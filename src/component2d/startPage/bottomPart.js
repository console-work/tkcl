      ...
      <div className="container mx-auto">
        <div className="grid gap-8 sm:grid-cols-2 sm:px-32 sm:gap-8 md:grid-cols-4 md:px-10 lg:px-20 xl:px-52 justify-items-center">
          ...
          <div className="bg-white w-[140px] p-6 rounded-md shadow-slate-400 shadow-md relative">
            ...
            <h3 className="text-[12px] font-semibold">Images <br></br>Processed Daily</h3>
          ...
          <div className="bg-white w-[140px] p-6 rounded-md shadow-slate-400 shadow-md relative">
            ...
            <h3 className="text-[12px] font-semibold">Dedicated <br></br>Customer Support</h3>
            <div className="absolute top-[37px] -left-[35px]">
          ...
          <div className="bg-white w-[140px] p-6 rounded-md shadow-slate-400 shadow-md relative">
            ...
            <h3 className="text-[12px] font-semibold">or Less <br></br>Delivery Time</h3>
            <div className="absolute top-[37px] -left-[35px]">
          ...
          <div className="bg-white w-[140px] p-6 rounded-md shadow-slate-400 shadow-md relative">
            ...
            <h3 className="text-[12px] font-semibold">Free <br></br>Trial Images</h3>
            <div className="absolute top-[37px] -left-[35px]">
