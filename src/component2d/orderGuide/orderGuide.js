        ...
        <div className="pt-7 pb-10 ">
          <div className="grid grid-cols-2 mr-5 gap-6 sm:grid-cols-3 sm:px-16 sm:gap-12 lg:grid-cols-4 xl:grid-cols-6 lg:gap-8 lg:px-16 xl:px-4 justify-items-center">
            <div className="bg-[#B1CC40] w-[140px] h-[130px] p-3 rounded-md border-2 border-white shadow-lg relative">
              <div className="">
                <img alt="order-1" loading="lazy" className="w-[30px] h-[30px]" src={order1.src} />
              </div>
              ...
              <div className="absolute -top-[15px] -left-[14px] w-[190px]">
                <img alt="arrow" loading="lazy" className="w-full" src={arrow.src} />
              </div>
            </div>
            <div className="bg-[#B1CC40] w-[140px] h-[130px] p-3 rounded-md border-2 border-white shadow-lg relative">
              <div className="">
                <img alt="order-2" loading="lazy" className="w-[30px] h-[30px]" src={order2.src} />
              </div>
              <h1 className="border-b-2 border-white w-16 pb-2 mb-1 text-white font-semibold text-[16px] pt-2">
                STEP 2:
              </h1>
            ...
            <div className="bg-[#B1CC40] w-[140px]  h-[130px] p-3 rounded-md border-2 border-white shadow-lg relative">
              <div className="">
                <img alt="order-3" loading="lazy" className="w-[30px] h-[30px]" src={order3.src} />
              </div>
              <h1 className="border-b-2 border-white w-16 pb-2 mb-1 text-white font-semibold text-[16px] pt-2">
                STEP 3:
              </h1>
            ...
            <div className="bg-[#B1CC40] w-[140px] h-[130px] p-3 rounded-md border-2 border-white shadow-lg relative">
              <div className="">
                <img alt="order-4" loading="lazy" className="w-[30px] h-[30px]" src={order4.src} />
              </div>
              <h1 className="border-b-2 border-white w-16 pb-2 mb-1 text-white font-semibold text-[16px] pt-2">
                STEP 4:
              </h1>
            ...
            <div className="bg-[#B1CC40] w-[140px]  h-[130px] p-3 rounded-md border-2 border-white shadow-lg relative">
              <div className="">
                <img alt="order-5" loading="lazy" className="w-[30px] h-[30px]" src={order5.src} />
              </div>
              <h1 className="border-b-2 border-white w-16 pb-2 mb-1 text-white font-semibold text-[16px] pt-2">
                STEP 5:
              </h1>
            ...
            <div className="bg-[#B1CC40] w-[140px]  h-[130px] p-3 rounded-md border-2 border-white shadow-lg relative">
              <div className="">
                <img alt="order-6" loading="lazy" className="w-[30px] h-[30px]" src={order6.src} />
              </div>
              <h1 className="border-b-2 border-white w-16 pb-2 mb-1 text-white font-semibold text-[16px] pt-2">
                STEP 6:
              </h1>
              ...
              <div className="absolute -top-[15px] -left-[14px] w-[164px]">
                <img alt="arrow" loading="lazy" className="w-full" src={arrow3.src} />
              </div>
            </div>
          </div>
        </div>
