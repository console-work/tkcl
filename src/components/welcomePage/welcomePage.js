...
const WelcomePage = () => {
  return (
    <>
      {/* ফন্ট বা গুরুত্বপূর্ণ ছবি প্রিলোড */}
      <link
        rel="preload"
        href="/images/sideArtV1.webp"
        as="image"
        type="image/webp"
      />
      <link
        rel="preload"
        href="/images/logo2.webp"
        as="image"
        type="image/webp"
      />
          ...
          <div className="flex flex-col lg:flex-row items-center py-5 lg:py-0">
            ...
            <div className="flex justify-end lg:h-[400px] items-center">
              ...
              <p className="w-full px-3 lg:w-3/4 lg:pl-0 lg:px-0 xl:px-0 text-white text-sm md:text-base text-justify" style={{ lineHeight: "1.6" }}>
                ...
                contents with creativity, and precision and turning them into
                stunning realities. With a versatile range of services in
               ...
               <br />
                ...
                integration that sets us apart. This amazing technology has
                allowed us to redefine how we enhance product images. Retouched.ai
                easily and quickly removes backgrounds from your photos with the
