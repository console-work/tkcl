...
const WelcomePage = () => {
    return (
        <div className="">
            <div className="bg-[#7C9C30] relative">
                <div className="container mx-auto">
                    <div className="flex flex-col lg:flex-row items-center py-5 lg:py-0 relative">

                        {/* Left side art and logo (Desktop) */}
                        <div className="hidden lg:block absolute bottom-0 left-0">
                            <div className="relative w-[250px] lg:w-[320px] xl:w-[360px] min-h-[360px]">
                                <Image
                                    src={sideArt}
                                    alt="sideArt"
                                    className="w-auto h-auto"
                        ...
                        {/* Mobile logo */}
                        <div className="block lg:hidden pt-5 flex justify-center w-full">
                            <Image
                                className="w-[120px]"
                                src={logowhite}
                                alt="logo"
                        ...
                        {/* Text Content */}
                        <div className="flex flex-col justify-center lg:h-[400px] items-end order-1 lg:order-none w-full">
                            <div className="w-full px-3 lg:w-[600px] xl:w-[640px] lg:pl-20 text-white text-sm md:text-base text-justify">
                                <p className="mb-4">
                                    The KOW Company has been a leading name in the world of E-commerce as a relentless player in Studio Image &amp; 3D post-production contents.
                                </p>
                                <p className="mb-4">
                                    We are constantly developing visual contents with creativity, and precision and turning them into stunning realities. With a versatile range of services in traditional image editing, we are equally proud of our remarkable 3D modeling, rendering, and architectural visualization abilities.
                                </p>
                                <p className="mb-4">
                                    We have skilled artists and designers who create stunning 3D visuals and lifelike renderings that leave a lasting mark.
                                </p>
                                <p className="mb-4">
                                    To make things more streamlined, <strong>Retouched.ai</strong> is our advanced AI integration that sets us apart. This amazing technology has allowed us to redefine how we enhance product images.
                                </p>
                                <p className="mb-4">
