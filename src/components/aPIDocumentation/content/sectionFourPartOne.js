  ...
  return (
    <div className="flex flex-col">
      ...
      <ParagraphOne className="mb-[28px]">
        <span className="font-semibold ml-2">Listing 1:</span> System Sign-Up Request and Response
      </ParagraphOne>
      ...
      <div className="bg-[#F2F2EA] p-4 shadow-md font-anek-latin w-full mx-auto relative">
        <pre className="text-sm text-gray-800 overflow-x-auto overflow-y-hidden">
          ...
          {"{"}
          <br />
          &nbsp;&nbsp;<span className="text-[#A01ED4]">"email"</span>: <span>"user@example.com"</span>
          <br />
          {"}"}
          <br />
          Response:
          ...
          {"{"}
          <br />
          &nbsp;&nbsp;<span className="text-[#A01ED4]">"message"</span>: <span>"Sign-up Successful."</span>,
          <br />
          &nbsp;&nbsp;<span className="text-[#A01ED4]">"status"</span>: <span>"success"</span>,
          <br />
