            ...
            <div className="container mx-auto py-4  md:pt-20 ">
                <div className=" justify-center items-center grid grid-cols-1 lg:grid-cols-[500px_auto] gap-6 md:gap-28">
                    ...
                    <div className="px-3 lg:px-0 text-center lg:text-left ">
                        <h2 className="text-[28px] md:text-[44px]  font-bold border-b-2 leading-[50px] border-[#7C9C30]">Retouched.ai</h2>
                        <div className="">
                        ...
                        <div className='flex justify-center lg:justify-start pt-7 '>
                            <h3 className="block">
                            <Link className="cursor-pointer text-xs  font-semibold text-white px-8 py-2 bg-[#7C9C30] rounded-3xl" href="http://retouched.ai/" target="_blank" rel="noreferrer">
